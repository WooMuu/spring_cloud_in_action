DROP TABLE IF EXISTS licenses;
  ...
  `comment` VARCHAR(64) ,
  `license_max` bigint(64) NOT NULL,
  `license_allocated` bigint(64)
...
VALUES ('08dbe05-606e-4dad-9d33-90ef10e334f91', '442adb6e-fa58-471f3-9ca2-ed1fecdfe86c', 'core-prod','WildCat Application Gateway', 16,16);