...
public class LicenseServiceController {
    ...
    @RequestMapping(value = "/byorg", method = RequestMethod.GET)
    public List<License> getLicenses(@PathVariable("organizationId") String organizationId, HttpServletRequest request) {
